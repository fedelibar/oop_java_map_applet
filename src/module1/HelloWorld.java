...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, 300, 450, provider);
		...
		map2 = new UnfoldingMap(this, 400, 50, 300, 450, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(-34.9f, -56.2f));
